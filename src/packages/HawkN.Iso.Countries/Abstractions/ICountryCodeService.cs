...
public interface ICountryCodeService
{
    ...
    IEnumerable<Country> SearchByName(string query);
    ...
    Country Get(CountryCode.TwoLetterCode code);
    ...
    /// <returns>The corresponding <see cref="Country"/> instance.</returns>
    Country Get(CountryCode.ThreeLetterCode code);
    ...
    bool TryGet(string code, [NotNullWhen(true)] out Country? country);
    ...
    ValidationResult ValidateByCode(string code, [NotNullWhen(true)] out Country? country);
    ...
    /// <param name="country">Contains the <see cref="Country"/> if validation succeeds.</param>
    /// <returns>A <see cref="ValidationResult"/> indicating success or failure reasons.</returns>
    ValidationResult ValidateByName(string name, [NotNullWhen(true)] out Country? country);
